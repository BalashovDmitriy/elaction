...
##
## В свои два места: нижняя площадка с пассажиром на ней кончается за 10 см до
## соседнего места, где на этаже ниже может быть проём шахты. Вход–выход ~58°
## против ~56° у оригинала, полотно ~66° против ~63° (ADR-0026, решение 6).
@export var escalator_run: float = Proportions.SLOT * 1.5 - Proportions.BODY_WIDTH * 0.5 - 0.1
