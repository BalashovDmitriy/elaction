...
## Красных дверей на здание вручную; −1 — по ROM, от 5 до 10 по навыку
## ([method BuildingDocuments.count]). Для тестов и прогонов, которым нужно здание
## с одним документом или вовсе без них (ADR-0028, решение 3).
##
