...
## Точка входа проекта.
##
## На этапе M4a грузит greybox-уровень, показывает счёт, жизни и документы,
## а рядом — отладочный оверлей с состоянием Otto. Игровой цикл и меню — в M5 и M8,
## пока что «игра окончена» только пишется в HUD.
