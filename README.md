...
| Статус | M17 — свет: камера чуть сверху, зоны ламп, отражения и рёбра, огоньки читаемости |
...
- Свет: зона светла, пока над ней висит лампа — конус вниз с мягкой тенью и слабая
  ...
  дают свету рёбра. Выстрел несёт вспышку. Столб света в шахте и город за окнами —
  M18 и M19.
