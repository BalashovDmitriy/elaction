...
| Статус | M19 — наполнение и задний план: ночной город за зданием, погода раунда, обстановка этажей, крыша по оригиналу |
...
- За зданием — ночной город: кварталы с горящими окнами в несколько рядов по
  ...
  поднимается к шахте ступенями, как в оригинале.
...
python tools/capture.py M19  # скриншоты вехи в screens/M19/
python tools/compare_original.py M19  # кадр вехи рядом с оригиналом
