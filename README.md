...
| Статус | Идёт M24b — вертолёт, красная дверь, паркинг и выход через машину; веха почти готова. Пройдена M24a — баги, дождь и быстрые пули. Дальше M24c — анимация, клавиши и прогрев шейдеров. |
...
- Раунд начинается с вертолёта: он влетает над крышей, спускает трос, Otto съезжает
  и вертолёт уходит — как в версии для ZX Spectrum. Сценку можно пропустить прыжком,
  выстрелом или паузой. Над верхней шахтой — машинное отделение.
...
- Здание заканчивается в подземном паркинге: Otto сам подходит к своей машине у ворот
  и садится в открытую дверь, загораются фары, поднимаются рольворота, и машина
  уезжает по пандусу на улицу. Бонус досчитывается поверх сцены, дальше затемнение и
