...
| Статус | M18b — вид и ход: эскалатор конструкцией, свет в шахте, двухэтажная кабина, агенты ездят в лифтах |
...
- Лампы: на этаже их одна–три по ширине; сбитая падает, убивает агента под собой и
...
python tools/capture.py M18a  # скриншоты вехи в screens/M18a/
...
```powershell
godot --path . res://tools/light_bench.tscn           # 1.97 мс из 16.6 на M18b
```
