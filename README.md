...
| Статус | M22 — грейдинг и полировка: тон нуара, уровень «Ультра», разрешение до 4K, новый HUD, город с огнями и неоном, молнии в дождь |
...
отдельно от узлов сцены и переехали без правок. Мир собран из моделей паков и
фактур, свет настоящий: конусы ламп с мягкими тенями, отражения в полированном
...
- Интерфейс: главное меню, пауза, настройки (три громкости, язык, сложность,
  ...
  рекордов и экран управления. Два языка — русский и английский, по локали
  системы. HUD — неоновые плашки в цвет вывески здания: очки, папки документов,
  жизни силуэтами, имя здания и этаж, где Otto, раунд и тревога.
...
каталоге и в `CREDITS.md`, иначе тест не пропустит.
...
```powershell
godot --path . res://tools/light_bench.tscn           # три этажа с агентами
