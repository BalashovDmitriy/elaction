...
| Статус | M18e — здание по карте оригинала: двери, красные двери и тёмные этажи по таблицам аркадного ROM, здания разные от партии к партии |
...
python tools/capture.py M18E  # скриншоты вехи в screens/M18E/
python tools/compare_original.py M18E  # кадр вехи рядом с оригиналом
