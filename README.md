...
| Статус | Идёт M24e — демо-режим: главное меню, простоявшее 45 секунд без нажатий, уступает место игре, которую ведёт бот, — с крыши, из середины или снизу здания; любая клавиша или кнопка возвращает в меню. Пройдена M24d — добивания вместо удара ногой. |
...
- Бой: пистолет с ограничением в три пули на экране и добивания вплотную, враги-агенты
  ...
  сверху Otto напрыгивает сам. Мир на время сценки замедляется, камера наезжает на
  пару, Otto уязвим; добивание стоит 200–300 очков против 100 за выстрел. Три жизни, Game Over, а после смерти —
