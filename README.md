...
| Статус | Идёт M24c — анимация и клавиши: движение клипами Universal Animation Library, прыжок фазами, переназначение клавиш, прогрев шейдеров. Пройдена M24b — вертолёт, красная дверь, паркинг и выход через машину. Дальше M24d — демо-режим. |
...
- Актёры: люди из пака Quaternius (CC0) — Otto в светлом костюме, агенты в тёмных
  ...
  (Quaternius, CC0), перенесённые на скелет пака; присед на корточках, лёжа и удар
  ногой в полёте — позы кодом под высоты пуль ROM. Переход между позами короткий
...
- Интерфейс: главное меню, пауза, настройки (три громкости, язык, сложность,
  ...
  рекордов и экран управления с переназначением клавиш. Первое здание партии
