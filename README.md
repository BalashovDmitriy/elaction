...
| Статус | M16 — актёры: Otto, агенты и машина — модели на скелете, анимация кодом |
...
текстур, один источник света на этаж. Актёры уже модели на скелете; двери, кабина,
лампы и выход светятся сами и читаются на погашенном этаже, актёров там держит обводка.
