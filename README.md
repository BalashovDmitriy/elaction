...
| Статус | Идёт M24a — баги, дождь и быстрые пули по замечаниям после M23; веха готова, осталось влить. Пройдена M23 — звук: нуар-джаз, эффекты и фон из свободных библиотек. Дальше M24b — крыша, двери, паркинг и выход, M24c — анимация и клавиши. |
...
- Двери: за красными документы по 500 очков — на выходе; створка закрывается за
  Otto, внутри он ровно 4,7 с, коридор оттуда слышно глухо, а потерявший его агент
  иногда ждёт у двери. Выход из здания без всех документов возвращает к верхней несобранной двери.
...
- Пуля — тонкий трассер, втрое быстрее аркадной; у ствола вспышка и дымок, на
  ...
  ствола идёт красный луч прицела на высоте будущей пули. Убитые агенты лежат
  до конца здания.
- Дождь светом: капли видны там, где на них падает свет лампы, шахты и неона,
  гаснут о крышу и технику, разбиваются брызгами, по лужам идут круги; над
  крышей водяная дымка. Город позади — с этажами, окнами за шторами и
...
- Звук: шпионский нуар-джаз Kevin MacLeod — четыре трека здания и три тревоги
  по жребию здания, свой трек у меню и конца партии; тревога входит наплывом, за
  красной дверью и на паузе музыка глуше. Эффекты и фон — Kenney и freesound
  (CC0, CC-BY): шаг по ковру отеля и камню конторы, гул кабины и шахты, неон
  вывески, на крыше и у выхода улица и дождь, на этажах дождь за стеклом, гром за
  молнией.
