...
| Статус | M20 — детализация сцены: лифт как на референсе, крыша с техникой и неоном, детальные двери, лампы и этажи, гараж с машиной, искры и кровь |
...
python tools/capture.py M20  # скриншоты вехи в screens/M20/
python tools/compare_original.py M20  # кадр вехи рядом с оригиналом
