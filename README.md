...
агентов и уходит на машине. Цвета — от версии для ZX Spectrum: бирюзовые этажи, красная
кладка, жёлтые двери, синяя шахта, — но нарисованы своим движком, с динамическим светом,
нормал-мапами и пост-обработкой. Лампы на этаже можно прострелить, и этаж погрузится
в темноту.
...
| Статус | M13 — нативный FullHD: мир втрое крупнее, текстуры перерисованы с деталью |
...
- Каждый раунд красится своей палитрой, и набор идёт по кругу — как цвета в оригинале.
  Погашенный этаж отличается от горящего оттенком, а не яркостью: в темноте агенты
...
- Картинка нативная в 1920×1080: мир измеряется втрое крупнее, а ассеты рисуются
  с деталью, которой в прежнем масштабе не было, — разнотон кирпича, фаски плит,
  филёнки дверей, патрон лампы.
...
godot --path . res://tools/round_shot.tscn            # палитры раундов, крыша и трос
...
кто стоял рядом и сколько агентов уложил.
