...
##
## Замер 2026-09-22 на трёх сидах: **5, 2 и 1**. Сиды 2 и 3 повторяются от
## прогона к прогону и сходятся с `tools/playthrough.gd --agents --endless`
## до шага. Сид 1 не повторяется: тест давал на нём 4 и 5 смертей в двух
## прогонах подряд, инструмент — 2. Расхождение записано в долг.
##
