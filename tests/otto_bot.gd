...
## теперь луч прицела, а пуля в полёте — запасной: замах бывает и нулевым.
...
## поздно, а луч горит весь замах (ADR-0037, решение 5). Пуля в полёте — запасной
## знак: при злости 10 и выше замах нулевой, и луча нет вовсе.
