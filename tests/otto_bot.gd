...
##
## **Вне габарита кабины, а не у самого края проёма.** Кабина широкая 1.2 м
## (`elevator_car.tscn`, `RoofShape`), то есть занимает 0.6 м от оси; Otto
## широк [constant BODY_HALF_WIDTH] = 0.27. Значит его середина обязана держаться
## дальше 0.87 м от оси, иначе край заходит в габарит кабины.
##
...
## [code]WAIT_ASIDE - REACHED[/code] = 1.08 м, он поэтому не встаёт — с запасом
## в 0.21 м от опасных 0.87.
##
