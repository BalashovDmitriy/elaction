...
Сетка мест, силуэт порогом, перехлёст шахт, эскалаторы полосой, внутренние
стены. Первым делом — лимит прогона тестов: 575 с при потолке 600, а веха
добавит сценовые тесты.
