...
1. Двери — обычная и красная, кабина лифта, эскалатор, лампа, выход.
2. Город за окнами получает текстуры, правила раскладки из M6 остаются.
3. Скриншоты вехи и авторевью.
## Принятые решения
