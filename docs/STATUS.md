...
- [ ] Общий стиль плашек (из `Hud`), тема на Exo 2
- [ ] Фон: `MenuStage` — город со своей камерой; пауза — размытая игра
- [ ] Неоновая вывеска
- [ ] Страницы: колонка, плашки, переключатели, рекорды сеткой
- [ ] Анимация переходов и выбора, звуки интерфейса
- [ ] Pixellari → Exo 2 в сцене: вывеска, таблички, табло
- [ ] Тесты
