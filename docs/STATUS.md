...
| **Текущая веха** | M4a — бой и враги |
| **Ветка** | `feat/m4a-combat` |
| **Состояние** | Механика сверена и зафиксирована в [ADR-0006](adr/0006-combat-and-enemies.md), реализация начата |
