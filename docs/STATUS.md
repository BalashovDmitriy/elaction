...
| **Состояние** | Вопросы закрыты, ADR-0036. Дальше — кандидаты на слух |
...
- [ ] Кандидаты на слух: страница с плеером по каждому слоту
- [ ] Выбранное — в игру: треки, джинглы, эффекты, фон
- [ ] Микс: шина `Ambience`, фильтры, наплыв тревоги, гром к молниям
- [ ] Синтез удалён; авторы и тест на авторство
