...
| **Состояние** | DoD вехи выполнен, проверки зелёные (173 теста); авторевью и PR впереди |
...
**Замер DoD:** здание 1, этаж 7 погашен, агенты стреляют — **0.50 мс/кадр** (RTX 5060 Ti).
Запас к бюджету 60 FPS — тридцатикратный.
