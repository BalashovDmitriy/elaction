...
- **M24d — добивания вместо удара ногой** ([ADR-0040](adr/0040-takedowns.md)):
  прыжок без удара; выстрел вплотную — случайная сценка, сзади удушение или
  свёрнутая шея, спереди серия ударов или рукоятью, сверху напрыгивание; мир
  замедляется, Otto уязвим. Исследование и вопросы пройдены.
