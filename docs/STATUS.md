...
| **Состояние** | Механика готова и снята кадрами; дальше авторевью, `check.ps1`, README |
...
- [x] Правила — `Takedown`: вплотную 0,9 м впереди по взгляду Otto на том же
      ...
      горизонтали; сценки таблицами поз по времени, случайно без повтора
      подряд; очки 200/300/300, +100 в темноте
