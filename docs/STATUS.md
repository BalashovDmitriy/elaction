...
- [x] Правки: шина Interface — меню и джинглы мимо глушения за дверью; тест поездки агента в лифте больше не зависит от жребия; агент не стреляет в неуязвимого Otto (целится, пуля ждёт)
