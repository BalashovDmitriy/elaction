...
| **Текущая веха** | M18c — пропорции по оригиналу |
| **Ветка** | `feat/m18c-proportions` |
| **Состояние** | M18b влита (PR #31). M18c не начата: впереди сверка с оригиналом и вопросы. 391 тест за 139 с |
| **Точка отката** | `main` держит 3D-сборку с M18b; 2D осталась в истории, `d5774df` |
...
Следующая — **M18c**, пропорции по оригиналу.
