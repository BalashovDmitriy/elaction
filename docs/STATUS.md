...
| **Текущая веха** | M24e — демо-режим |
| **Ветка** | `feat/m24e-demo` |
| **Состояние** | Сверка и вопросы пройдены, ADR-0041; начата реализация |
...
- [ ] Бот переезжает из `tests/` в `src/`
- [ ] Отсчёт бездействия в главном меню, запуск и конец демо
- [ ] Три точки по кругу, 30 с, смерть кончает демо
- [ ] Рекорды и замер качества демо не трогает
