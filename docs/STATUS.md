...
| **Текущая веха** | M23 — звуковое сопровождение |
| **Ветка** | `feat/m23-sound` поверх `docs/m22b-merged` |
...
После M23 — **M24, полировка по замечаниям пользователя** (2026-09-25): кабина,
которая встаёт между этажами и не выпускает Otto; мерцание верха и низа шахты;
дождь сквозь крышу и дождь целиком; полосы на фоне при движении; пули; трупы
агентов; документов 5–10 жребием; справка по управлению на паузе и
переназначение клавиш; выход через машину; паркинг на нижнем этаже; плавная
анимация и приземление; понятное правило падения; откуда Otto берётся на
крыше. Сначала разбор и вопросы.
Лидерборд сдвинулся в **M25**. План — в [EPIC.md](EPIC.md).
