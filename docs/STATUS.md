...
| **Состояние** | Переезд идёт: метрика, `WorldSpace`, камера, Otto и пуля в 3D. Дальше — агент, двери, лифты, уровень |
...
Идёт **M15** — первая веха пивота: слой узлов переезжает на 3D, кадр из серых коробок.
