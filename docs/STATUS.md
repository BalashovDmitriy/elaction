...
| **Текущая веха** | M24d — добивания вместо удара ногой |
| **Ветка** | `feat/m24d-takedowns` |
| **Состояние** | Исследование и вопросы пройдены, ADR-0040; начата реализация |
...
- [ ] Прыжок без удара: клип полёта UAL, зона удара и очки за удар уходят
- [ ] Правила добивания без узлов: кто вплотную, сторона, сценка, очки
- [ ] Клипы UAL 2 в сборку; сценки позами кодом поверх клипов
- [ ] Режиссёр сценки: агент на смещение, два рига по одним часам, смерть и
      очки на ключевом кадре
- [ ] Замедление мира, Otto уязвим
- [ ] Напрыгивание сверху
- [ ] Бот добивает; тест боя в пороге
- [ ] Кадры, авторевью, `check.ps1`, README
- [ ] PR

## Что дальше

- **M24e — демо-режим:** автомат между партиями крутит игру сам; включается по
