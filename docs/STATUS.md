...
- [ ] Шахта без совпадающих граней; тест на любом здании
- [ ] Дождь: коллизия с крышей, брызги, круги, мокрая крыша, капель, слои в
      городе; замер
- [ ] Фон: ровная камера со сдвигом объектива, сглаживание, расфокус за ближним
      рядом
...
- **M24b — здание: крыша, двери, паркинг, выход:** откуда Otto берётся на
  крыше; красная дверь закрывается за Otto, время внутри жребием 3–6 с, сквозь
  дверь слышно коридор, агенты подходят к двери (в ROM — 70 тиков, выйти раньше
  нельзя); нижний этаж — паркинг; выход через машину: подошёл — сел и уехал.
