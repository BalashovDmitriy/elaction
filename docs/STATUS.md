...
| **Ветка** | `docs/m22b-merged` — итоги M22b в архив; ветка вехи ещё не заведена |
| **Состояние** | Начало вехи: сверка звука с оригиналом и вопросы. Кода вехи нет |
...
- [ ] Сверка звука с оригиналом: что звучит в аркаде, когда и как
- [ ] Вопросы вехи, ADR, план в EPIC

## Что дальше

После M23 — **M24, онлайн-лидерборд** (опционально). План — в [EPIC.md](EPIC.md).
