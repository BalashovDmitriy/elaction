...
| **Состояние** | Актёры, пули и машина собраны из ассетов, проверки зелёные (199 тестов); впереди авторевью и PR |
...
- **Otto: 12 поз**, агент: 8 (ему не нужны присед, прыжок и удар — этого не умеет
...
- **Тесты: 199** (было 186). Позы против состояний, три карты у каждой позы, общий кадр
  у всех поз актёра, привязка спрайта к ногам и машина, которая уезжает раньше сигнала.
