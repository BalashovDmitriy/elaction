...
| **Состояние** | Решения приняты и зафиксированы в [ADR-0008](adr/0008-building-generation.md), реализация начата |
...
Дальше: собрать здание из раскладки в сцене и замерить FPS.
