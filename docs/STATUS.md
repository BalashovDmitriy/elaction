...
- [ ] Вертолёт: влетает, спускает трос, Otto съезжает, вертолёт уходит; пропуск
- [x] Красная дверь: закрывается, 4,73 с, раньше не выйти, документ на выходе,
      ...
      **Открыто:** тест боя с агентами, сид 3 — было 4 смерти за 6028 шагов,
      стало 12 и не уложился в 7000 (без ожидающих агентов — 8): бот сидит за
      каждой красной дверью 4,7 с вместо мгновенного выхода, сложность растёт
      со временем здания. Сиды 1 и 2 — 1 и 0 смертей. Решать замером
- [ ] Подвал: одна шахта вниз, без эскалаторов; паркинг с колоннами, потолком,
      чужими машинами, воротами и пандусом; машина Otto у ворот слева
- [ ] Выход: подошёл — сел — фары — уехал; бонус поверх, затемнение
- [ ] Не все документы: звук, кадр едет вверх, Otto у пропущенной двери
- [ ] Кадры, авторевью, `check.ps1`, README, PR
...
| [ADR-0038](adr/0038-building-start-and-end.md) | M24b: вертолёт в каждом здании, красная дверь 70 тиков без раннего выхода, одна шахта в подвал-паркинг, выход через машину, возврат за документами как в ROM |
