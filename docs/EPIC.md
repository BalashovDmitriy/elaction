...
- [ ] `tools/render_audio.py`: синтез WAV квадратом, шумом и огибающими — словарь PSG
- [ ] SFX на все события игры: шаги, выстрел, попадание, удар ногой, лампа, лифт,
      эскалатор, дверь, документ, смерть, выход
- [ ] Своя тема в идиоме PSG и отдельный мотив на тревогу
...
- [ ] Пиксельный шрифт с кириллицей в `assets/fonts/` вместе с лицензией
- [ ] Два языка: `ru` и `en`, по локали системы, с переключателем
- [ ] HUD вместо отладочного оверлея: очки, жизни, документы, этаж, тревога
- [ ] Главное меню и настройки: громкости, язык, экран
- [ ] Локальная таблица рекордов
- [ ] Дополнительная жизнь за 10 000 очков — правка по сверке с мануалом Taito
- [ ] Тесты: строки есть на обоих языках, рекорды переживают перезапуск
