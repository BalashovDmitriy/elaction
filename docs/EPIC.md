...
### M24b · Здание: крыша, двери, паркинг, выход

- [ ] Понятно, откуда Otto берётся на крыше
- [ ] Красная дверь как в оригинале (решение пользователя): закрывается за Otto,
      раньше времени не выйти; время внутри жребием 3–6 с (в ROM ровно 70 тиков,
      ~4,7 с); сквозь дверь глухо слышно коридор; агенты, потерявшие Otto, иногда
      подходят к его двери
- [ ] Нижний этаж — паркинг
- [ ] Выход через машину: подошёл — сел и уехал
