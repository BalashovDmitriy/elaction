...
**M23** — звук (PR #44). Идут **M24a–c** — полировка по замечаниям, затем
...
- [ ] Вертолёт в каждом здании: влетает, спускает трос, Otto съезжает, вертолёт
      уходит; пропуск клавишей
- [ ] Красная дверь: закрывается за Otto, внутри 70 тиков ROM (4,73 с), раньше
      не выйти, документ на выходе; сквозь дверь глухо; агенты иногда ждут у двери
- [ ] Подвал: одна шахта вниз, без эскалаторов; паркинг — колонны, потолок с
      трубами и лампами, чужие машины, ворота и пандус; машина Otto у ворот слева
- [ ] Выход: подошёл — сел — фары — уехал в ворота; бонус поверх, затемнение
- [ ] Без всех документов лифт в подвал не везёт

### M24c · Анимация и клавиши

- [ ] Плавная анимация на клипах пака, приземление без «колен»
