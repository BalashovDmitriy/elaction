...
- [ ] Числа боя вынести в правила здания, как вынесены злость и плотность дверей
- [ ] Тесты: бот проходит настоящее здание с включёнными агентами

**DoD:** бот проходит настоящее тридцатиэтажное здание с агентами, не исчерпав
трёх жизней. **Пока не достигнут:** бот доходит до 6–18 этажа из 29 и собирает
1–3 документа из 5. Замеры и что известно — в ADR-0016, «Где веха встала».

### M12 · Палитра раунда и крыша

Решения — [ADR-0015](adr/0015-round-palette-and-roof.md). Ориентир — версия для
ZX Spectrum, но только в устройстве уровней: вид остаётся своим, со светом из M6.

- [ ] Палитра переезжает из констант уровня в правила здания и меняется по раунду
- [ ] Палитра задаёт обе пары цветов — горящего этажа и погашенного
- [ ] Надстройка машинного отделения на крыше, Otto спускается к ней по тросу
- [ ] Тесты: на каждой палитре набора погашенный этаж отличим от горящего

**DoD:** здания подряд отличаются на глаз, и погашенный этаж читается в каждом.

### M13 · Онлайн-лидерборд (опционально)
