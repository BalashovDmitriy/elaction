...
Пройдены M0–M22, все влиты в `main` (последняя — M22, PR #40); пивот в 3D
закончен. Идёт сверка всей документации, затем **M23** — звуковое
...
- [ ] За главным меню — ночной город со своей камерой, погода жребием; на
      паузе и в конце партии — игра, размытая и затемнённая
- [ ] Название — неоновая вывеска «ELACTION», одна буква мигает
- [ ] Один шрифт — Exo 2: меню, вывеска на фасаде, таблички, табло; Pixellari
      уходит из проекта
- [ ] Колонка слева, пункты — плашки в стиле HUD; стиль плашек общий с HUD
- [ ] Переключатели «‹ значение ›» вместо выпадающих списков; рекорды сеткой
- [ ] Переходы между страницами и подсветка выбора с анимацией
- [ ] Звуки наведения, выбора и возврата — синтезом
- [ ] Тесты: каждая страница собирается и держит фокус с геймпада, фон
