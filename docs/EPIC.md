...
**M23** — звук (PR #44), **M24a** (PR #45), **M24b** (PR #47), **M24c** (PR #48) и
**M24d** (PR #49). Идёт **M24e** — демо-режим и **M25** — онлайн-лидерборд (опционально).
...
- [ ] 45 с бездействия в главном меню — демо; любое нажатие — назад в меню
- [ ] Около 30 с, три точки по кругу: крыша, середина, низ; смерть кончает демо
- [ ] Звук как в игре, без надписи; рекорды и замер качества не трогаются
