...
сверкой документации и её долгом); пивот в 3D закончен. Идёт **M23** —
звуковое сопровождение, затем **M24** — онлайн-лидерборд (опционально).
...
### M24 · Полировка по замечаниям

Замечания пользователя после M23 (2026-09-25). Состав уточняется разбором и
вопросами на старте вехи.

- [ ] Кабина, подъехавшая к этажу, не застревает вместе с Otto между этажами
- [ ] Верх и низ шахты не мерцают
- [ ] Дождь заново: не проходит сквозь крышу, капли бьют по крыше и это видно
- [ ] Фон не перерисовывается полосами, когда камера едет
- [ ] Пули естественнее и быстрее
- [ ] Трупы агентов остаются
- [ ] Документов в здании 5–10 жребием
- [ ] Справка по управлению на паузе, переназначение клавиш
- [ ] Выход через машину: подошёл — сел и уехал
- [ ] Нижний этаж — паркинг
- [ ] Анимация плавнее, приземление без «колен»
- [ ] Понятное правило, когда Otto разбивается
- [ ] Понятно, откуда Otto берётся на крыше в начале здания
