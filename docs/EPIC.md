...
- [ ] Тип здания и имя — жребий по зданию: отель или офисная башня
- [ ] Каталог моделей `PropCatalog`, модели паков в `assets/models/props/`,
      `CREDITS.md` с автором и лицензией каждой модели и фактуры
- [ ] Обстановка этажей: на стенах между дверями бра, картины, часы, доски,
      номера комнат; на полу мебель на каждом втором свободном месте
- [ ] Стены — фактуры по типу здания с тоном раунда множителем
- [ ] Шахта стальная: листы с болтами, бетон, распорки, хромированный портал
- [ ] У портала табло этажа кабины со стрелкой и кнопки ▲▼ (только вид)
- [ ] Вертикальная неоновая вывеска на углу фасада; неон с крыши уходит
- [ ] Крыша моделями: бак, кондиционеры, антенны, тарелка, вентиляция, панели,
      выход; покрытие фактурой
- [ ] Тесты: у каждой модели строка в CREDITS, модели без тел и влезают по
