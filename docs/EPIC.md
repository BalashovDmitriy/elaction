...
- [ ] Выход с собранными документами → бонус → следующее здание
- [ ] Бонус за здание (1000 × номер — не сверено)
- [ ] Сложность растёт агентами: чаще стреляют, дальше видят, быстрее приходят на смену
- [ ] Тревога по фиксированному времени на здание: агенты злее, кабина отвечает
      с задержкой. Смерть тревогу не снимает, сбрасывает только смена здания
- [ ] Пауза по Esc с подсказкой: продолжить, начать заново, выйти
- [ ] Тесты: тревога, бонус и номер здания, отклик кабины с задержкой
