...
в M10 ([ADR-0014](0014-building-architecture.md), пункт 4), и это та же мера,
...
Порог поставлен по худшему замеренному сиду — три. Правится он замером, как и
...
- **Стрелять из кабины.** Присесть там нельзя (ADR-0004, пункт 3), поэтому
