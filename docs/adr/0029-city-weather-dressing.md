...
с `World3D`) под **перспективной камерой**, которая едет за основной с
уменьшенным ходом. Картинка подкладывается фоном основного кадра
...
- **Дождь** — частицы в виде города и косые струи в просветах основного кадра,
  туман чуть плотнее.
...
лампой падать ей некуда. Высотой предмет ниже пояса Otto там, где стоит на полу,
чтобы силуэт актёра не терялся на его фоне.

### 4. Крыша — силуэтом за игрой

Решение пользователя. Скаты ступенями по бокам шахты и парапеты по краям — декор
за плоскостью игры. Otto ходит по плоскому настилу, как сейчас: путь, бот и
проверки проходимости не меняются, а в кадре читается верх дома.

### 5. Палитра раунда — материалами и светом

Приём ADR-0017 возвращается не цветом заливки, а материалами: тон задней стены,
кладки и шахты берётся из палитры раунда, лампы светят её тёплым светом. Разница
...
слабо. Тёмный этаж карты (ADR-0028, решение 4) получает свой, более холодный и
низкий тон; огоньки читаемости остаются.
