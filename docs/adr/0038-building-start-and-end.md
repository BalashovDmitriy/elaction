...
### 5. Без всех документов лифт в подвал не везёт

Решение пользователя — проще, чем в ROM. Шахта, которая доходит до подвала,
останавливается этажом выше, пока не собраны все документы: ни под управлением
Otto, ни в автономной езде кабина ниже не идёт. Собран последний — нижняя
остановка открывается. Упасть в подвал сквозь шахту тоже нельзя: пока он
заперт, дно шахты стоит над ним. Возврата за документами — звука, проезда кадра
вверх, переноса к двери из ROM — нет; прежний мгновенный перенос уходит.
