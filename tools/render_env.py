...
def shaft_rail() -> Canvas:
    ...
    авторевью M12). Тайл замкнут по вертикали, ширина — `BuildingShafts.RAIL_WIDTH`.
    """
...
def shaft_door() -> Canvas:
    ...
    Размер — ширина шахты на `BuildingShafts.DOOR_HEIGHT`. Две половинки
...
def machine_room() -> Canvas:
    ...
    (ADR-0017, решение 4). Размер — `BuildingShafts.MACHINE_ROOM_SIZE`.
